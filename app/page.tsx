            ...
            >
                ...
                <div className="absolute inset-x-0 top-[22.08%] mx-auto flex max-w-[40ch] flex-col items-start gap-[0.85em] lg:top-[1.5%] lg:max-w-[54ch]">
                    <div className="flex flex-col gap-[0.6em]">
                        ...
                        <p className="text-[1em] leading-[1.65] text-foreground">
                    ...
                    <Link
                        href="/apply"
                        className="inline-block rounded-lg bg-primary px-[1.5em] py-[0.75em] text-[1em] font-medium text-primary-foreground transition hover:bg-primary/90"
                    >
